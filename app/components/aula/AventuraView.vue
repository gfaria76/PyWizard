<template>
  <div class="space-y-8">
    ...
    >
      <header class="mb-5">
        <span class="inline-block font-label-caps text-[10px] tracking-widest text-primary-container uppercase">
          Trilha Aventura
        </span>
        <h2 class="font-headline-sm text-xl text-primary-container mt-1 uppercase tracking-wider">
          {{ block.title }}
        </h2>
      </header>
    ...
    <section v-if="closingSections.length" id="sec-fechamento" class="glass-panel rounded-xl p-6 md:p-8">
      <h2 class="font-headline-sm text-xl text-primary-container mb-6 uppercase tracking-wider">
        Fechamento
      </h2>
      <div class="space-y-5">
        <div
          ...
          :key="section.key"
          class="bg-surface-container-low/40 rounded-lg p-4 md:p-5 border-l-2 border-primary-container/40"
        >
          <h3 class="font-label-caps text-[11px] tracking-widest text-primary-container mb-2 uppercase">
            {{ section.title }}
          </h3>
