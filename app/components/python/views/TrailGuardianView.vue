    ...
    <section class="cg-panel rounded-3xl p-5 sm:p-7">
      <div class="mb-3 flex items-center justify-between gap-3">
        <div class="flex items-center gap-3">
          <UIcon name="i-lucide-shield-check" class="h-5 w-5 text-amber-200" />
          <h2 class="text-xl font-black text-slate-50">Rito do Guardião</h2>
        </div>
        <UBadge color="warning" variant="soft">Revisão acumulativa</UBadge>
      </div>
      <p class="text-sm leading-7 text-slate-300">
        Use esta trilha para consolidar o bloco antes do boss. A intenção aqui é revisar, ganhar confiança e chegar preparado para a arena.
      </p>
    </section>

    <QuestOpeningSection :sections="openingSections" />
    <QuestMissionBlocks subtype="guardiao" :mission-blocks="missionBlocks" :quest-slug="questSlug" :tipo-aula="tipoAula" />
